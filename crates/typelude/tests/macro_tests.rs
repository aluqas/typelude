...
fn test_logic_ops() {
    ...
    type ResAnd = program! {
        (push typelude::std::prim::bool::True)
        (push typelude::std::prim::bool::True)
        (and)
    };
    ...
    type ResOr = program! {
        (push typelude::std::prim::bool::False)
        (push typelude::std::prim::bool::True)
        (or)
    };
...
fn test_control_flow_while() {
    ...
    type ResWhileZero = program! {
        (push 1)
        (while { (push typelude::std::prim::bool::False) } { (push 0) })
    };
