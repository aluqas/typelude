...
use typelude_tooling_core::{
    CandidateId, EventId, GoalId, HookId, ItemId, RunId, TraceEvent, TraceEventKind,
};
...
pub trait TraceEventExt {
    ...
    fn with_item_id(self, item_id: ItemId) -> Self;
...
impl TraceEventExt for TraceEvent {
    ...
    fn with_item_id(mut self, item_id: ItemId) -> Self {
