...
use crate::{
    ...
    opcode::{OpIf, OpWhile},
    vm::algebra::{
        effect::{InvalidCondition, PushTrace, PutVm, Then, ThrowVm, VmFx, VmTrace, VmTrap},
...
where
    ...
    ThenProg: crate::vm::algebra::program::InterpProgram<F>,
    ElseProg: crate::vm::algebra::program::InterpProgram<F>,
    PutVm<F, InitState, VmState<Stack, Locals, Memory, Frames>>: Eval,
    Then<
        F,
        PutVm<F, InitState, VmState<Stack, Locals, Memory, Frames>>,
        <ThenProg as crate::vm::algebra::program::InterpProgram<F>>::Output,
    >: Eval,
    Then<
        F,
        PutVm<F, InitState, VmState<Stack, Locals, Memory, Frames>>,
        <ElseProg as crate::vm::algebra::program::InterpProgram<F>>::Output,
    >: Eval,
...
where
    ...
    <OpWhile<CondProg, BodyProg> as LowerWhile<Nil>>::Output:
        crate::vm::algebra::program::InterpProgram<
                VmFx<VmState<Stack, Locals, Memory, Frames>, Trace, Trap, Req>,
            >,
{
    type Output = <<OpWhile<CondProg, BodyProg> as LowerWhile<Nil>>::Output as crate::vm::algebra::program::InterpProgram<
        VmFx<VmState<Stack, Locals, Memory, Frames>, Trace, Trap, Req>,
    >>::Output;
}
